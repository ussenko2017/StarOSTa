 ...
 * {@link addPredmetFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link addPredmetFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class addPredmetFragment extends Fragment {
     ...
     * @return A new instance of fragment addPredmetFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static addPredmetFragment newInstance(String param1, String param2) {
        addPredmetFragment fragment = new addPredmetFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_add_predmet, container, false);
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                try {
                                    if (editText.getText().toString().equals("") |
                                            (Integer.valueOf(editText2.getText().toString()) == 0) |
                                            editText2.getText().toString().equals("")){
                                        Toast.makeText(view.getContext(),"Ошибка", Toast.LENGTH_SHORT).show();

                                    }
                                    else{
                                        DBHelper.add_to_t3(view,editText.getText().toString(),Integer.valueOf(editText2.getText().toString()));
                                    }
