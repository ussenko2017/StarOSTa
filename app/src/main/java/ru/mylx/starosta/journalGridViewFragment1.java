...
public class journalGridViewFragment1 extends ListFragment {
    ...
    public journalGridViewFragment1() {
     ...
     * @return A new instance of fragment journalGridViewFragment1.
     */
    // TODO: Rename and change types and number of parameters
    public static journalGridViewFragment1 newInstance(String param1, String param2) {
        journalGridViewFragment1 fragment = new journalGridViewFragment1();
    ...
    public void onListItemClick(ListView l, final View v, final int position, final long id) {
        ...
        if (activitychecker ==  0){
            ...
            setListAdapter(adapter);
            activitychecker+=1;
            List<DBHelper.Ozhenka> list = (List<DBHelper.Ozhenka>) ozh_arr.get(5);



            setListAdapter(new DBHelper.OzhenkaAdapter(v.getContext(),(List<DBHelper.Ozhenka>) list.get(0)));
